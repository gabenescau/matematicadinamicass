...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans selection:bg-sky-100 selection:text-sky-900">
      ...
      {/* Hero Section */}
      <section className="bg-[#f4f9fc] pt-10 pb-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex items-center justify-center gap-2 text-sm text-slate-500 mb-6">
            ...
            <span className="font-bold text-emerald-500">143</span> pessoas estão vendo essa oferta!
          </div>

          <a 
            href="#planos"
            onClick={scrollToPlanos}
            className="bg-[#17a2b8] hover:bg-[#138496] text-white text-lg md:text-xl font-bold py-4 px-8 rounded-xl shadow-xl shadow-[#17a2b8]/20 transition-all hover:scale-105 active:scale-95 flex items-center justify-center mx-auto w-fit"
          >
      ...
      {/* Pricing Section */}
      <section id="planos" className="bg-[#f8fafc] py-16">
        <div className="max-w-5xl mx-auto px-4">
      ...
      {/* Guarantee Section */}
      <section className="py-16 bg-[#f4f9fc] px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <a 
            href="https://zuckpay.com.br/checkout/200-dinamicas-de-matematica-plano-premium"
            className="bg-[#17a2b8] hover:bg-[#138496] text-white text-lg md:text-xl font-bold py-4 px-8 rounded-xl shadow-xl shadow-[#17a2b8]/20 transition-all hover:scale-105 active:scale-95 mx-auto inline-block"
          >
